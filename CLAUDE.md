...
A YouTube video transcription system that downloads audio, transcribes it using ElevenLabs, and automatically categorizes transcripts into a knowledge library using Claude AI for theme classification.
